const kcpe = [
  {
    question:
      "In the human digestive system, absorption of food takes place in the",
    a: "stomach",
    b: "large intestine",
    c: "rectum",
    d: "small intestine",
  ...
  {
    question:
      "Which one of the following processes refers to the fusion of the egg and sperm?",
    a: "Implantation",
    b: "Parturition",
    c: "Fertilization",
    d: "Ovulation",
  ...
  {
    question:
      "The following practices help to maintain strong and healthy teeth except",
    a: "eating vegetables",
    b: "chewing sugarcane",
    c: "eating cakes",
    d: "drinking milk",
  ...
  {
    question:
      "The fourth and the seventh planets from the sun respectively are",
    a: "Earth and Saturn",
    b: "Venus and Neptune",
...
function loadkcpe() {
  const t_stitle = document.getElementById("testsubtitle");
  const t_select = document.getElementById("testchoice");
  if (t_select.value == "kcpe") {
    t_stitle.innerHTML =
      "Can you answer these primary school science questions?";
    deselectAnswers();
    console.log(kcpe);
    ...
    loadQuiz();
    t_stitle.innerHTML =
      "Can you answer these HTML, CSS & JavaScript Questions?";
  }
}
